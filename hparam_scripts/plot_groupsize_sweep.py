...
def main() -> None:
    ...
    parser.add_argument("--outputs_root", default="/scratch/weixuz/decore/outputs/hparam/groupsize_quick")
    parser.add_argument("--cluster_root", default="/scratch/weixuz/preference_head/cluster_runs")
    parser.add_argument("--group_sizes", default="10,50,100,200,400")
    parser.add_argument("--bootstrap", type=int, default=300)
    parser.add_argument("--out_dir", default="/scratch/weixuz/decore/outputs/hparam/figures/groupsize")
