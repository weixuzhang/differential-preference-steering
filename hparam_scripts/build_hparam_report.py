...
HYPARAM_DIR = ROOT / "decore" / "outputs" / "hparam"
...
def main() -> None:
    report_path = ROOT / "decore" / "HYPERPARAM_ABLATION_RESULTS.md"
    ...
    lines.append("")
    lines.append("Figure: `decore/outputs/hparam/figures/heads/heads_sweep.png`")
    lines.append("")
    ...
    lines.append("")
    lines.append("Figure: `decore/outputs/hparam/figures/groupsize/groupsize_sweep.png`")
    lines.append("")
    ...
    lines.append("")
    lines.append("Figure: `decore/outputs/hparam/figures/gamma/gamma_sweep.png` (LaMP-1)")
    lines.append("")
    ...
    lines.append("")
    lines.append("Figures: `decore/outputs/hparam/figures/ablation/ablation_metrics.png`, `decore/outputs/hparam/figures/ablation/ablation_head_heatmaps.png`")
    lines.append("")
    ...
    lines.append("")
    lines.append("Figure: `decore/outputs/hparam/routing_ablation/routing_ablation.png`")
    lines.append("")
