...
def main() -> None:
    ...
    parser.add_argument("--adaptive_pred", default="/scratch/weixuz/decore/outputs/hparam/gamma_full/adaptive/pred_LAMP_1_LLaMA3-8b-Instruct__DPSWeightedSoft.json")
    parser.add_argument("--fixed_pred", default="/scratch/weixuz/decore/outputs/hparam/gamma_full/fixed_alpha_0.5/pred_LAMP_1_LLaMA3-8b-Instruct__DPSWeightedSoft.json")
    parser.add_argument("--fixed_alpha", type=float, default=0.5)
    parser.add_argument("--bootstrap", type=int, default=300)
    parser.add_argument("--out_dir", default="/scratch/weixuz/decore/outputs/hparam/figures/gamma")
