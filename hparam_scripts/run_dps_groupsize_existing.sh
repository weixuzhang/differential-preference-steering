...
K_VALUES=(250 25)
HEAD_DIRS=(
  "/scratch/weixuz/preference_head/cluster_heads/lamp1_k250_llama3-8b-instruct_quick50"
  "/scratch/weixuz/preference_head/cluster_heads/lamp1_k25_llama3-8b-instruct"
)
...
for i in "${!GROUP_SIZES[@]}"; do
  ...
  run_dir="${ROOT}/decore/outputs/hparam/groupsize_quick/g${group_size}"
