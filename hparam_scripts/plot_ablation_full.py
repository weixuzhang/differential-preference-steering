...
def main() -> None:
    ...
    parser.add_argument("--random_heads_pred", default="/scratch/weixuz/decore/outputs/hparam/ablation_full/random_heads/pred_LAMP_1_LLaMA3-8b-Instruct__DPSWeightedSoft.json")
    parser.add_argument("--random_mask_pred", default="/scratch/weixuz/decore/outputs/hparam/ablation_full/random_mask/pred_LAMP_1_LLaMA3-8b-Instruct__DPSWeightedSoft.json")
    parser.add_argument("--true_heads_dir", default="/scratch/weixuz/preference_head/cluster_heads/lamp1_k25_llama3-8b-instruct")
    parser.add_argument("--random_heads_dir", default="/scratch/weixuz/preference_head/cluster_heads/lamp1_k25_llama3-8b-instruct_random")
    parser.add_argument("--random_mask_dir", default="/scratch/weixuz/preference_head/cluster_heads/lamp1_k25_llama3-8b-instruct_random_mask")
    parser.add_argument("--bootstrap", type=int, default=300)
    parser.add_argument("--out_dir", default="/scratch/weixuz/decore/outputs/hparam/figures/ablation")
    ...
    if args.true_pred:
        ...
        true_pred = _find_latest_true_pred(Path("/scratch/weixuz/decore/outputs"))
