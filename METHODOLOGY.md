...
`decore/hparam_scripts/` and use the dev split throughout.
...
- **Random-head ablations** (`run_llama3_lamp1_ablation_random_heads.sh`):
  ...
  - Outputs: `decore/outputs/hparam/ablation/random_heads` and
    `decore/outputs/hparam/ablation/random_mask`
