...
Located at: `/scratch/weixuz/preference_head/preference_scores/Meta-Llama-3-8B-Instruct_LaMP_1_top_heads.json`
...
- `/scratch/weixuz/decore/src/models/dps.py` - DPS decoder
- `/scratch/weixuz/decore/src/models/__init__.py` - Updated to import DPS

### Configuration Files
- `/scratch/weixuz/decore/configs/decoder/dps.yaml` - Base DPS config
- `/scratch/weixuz/decore/configs/experiment/lamp_1/dps/llama3_8b_instruct.yaml` - LaMP-1 config
- `/scratch/weixuz/decore/configs/experiment/lamp_2/dps/llama3_8b_instruct.yaml` - LaMP-2 config
- `/scratch/weixuz/decore/configs/experiment/lamp_3/dps/llama3_8b_instruct.yaml` - LaMP-3 config
- `/scratch/weixuz/decore/configs/experiment/lamp_4/dps/llama3_8b_instruct.yaml` - LaMP-4 config

### Scripts
- `/scratch/weixuz/decore/test_dps.sh` - Quick test script
- `/scratch/weixuz/decore/run_dps.sh` - Full experiment script (SLURM)

### Documentation
- `/scratch/weixuz/decore/DPS_INTEGRATION.md` - Comprehensive documentation
- `/scratch/weixuz/decore/DPS_QUICK_START.md` - This file
...
```bash
ls -lh /scratch/weixuz/preference_head/preference_scores/
```
...
| File Type | Location |
|-----------|----------|
| Preference Heads | `/scratch/weixuz/preference_head/preference_scores/` |
| DPS Decoder | `/scratch/weixuz/decore/src/models/dps.py` |
| DPS Configs | `/scratch/weixuz/decore/configs/experiment/lamp_*/dps/` |
| Test Script | `/scratch/weixuz/decore/test_dps.sh` |
| Run Script | `/scratch/weixuz/decore/run_dps.sh` |
| Output | `/scratch/weixuz/decore/outputs/` |
...
1. **Test on LaMP-1**: `bash test_dps.sh`
2. **Run full LaMP-1 experiment**: `sbatch run_dps.sh`
3. **Detect heads for other tasks**: Edit `/scratch/weixuz/preference_head/run_detection.sh`
...
See `/scratch/weixuz/decore/DPS_INTEGRATION.md` for:
...
- `/scratch/weixuz/preference_head/preference_head.md` - Detection methodology
