...
```bash
# 1. Create configs
cp /scratch/weixuz/decore/configs/data/lamp_4.yaml \
   /scratch/weixuz/decore/configs/data/lamp_5.yaml

cp /scratch/weixuz/decore/configs/data/lamp_4.yaml \
   /scratch/weixuz/decore/configs/data/lamp_7.yaml
...
mkdir -p /scratch/weixuz/decore/configs/experiment/lamp_5/dps
mkdir -p /scratch/weixuz/decore/configs/experiment/lamp_7/dps
...
1. **Update dataset loader** to support LongLaMP
   - Modify `/scratch/weixuz/decore/src/datasets/lamp.py`
