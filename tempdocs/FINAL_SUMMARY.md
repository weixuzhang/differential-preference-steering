...
decore/
├── run_all_methods.sh              # Run all methods
├── run_dps_multi_model.sh          # Run DPS only
├── test_cad_cd.sh                  # Quick test
...
```bash
cd /scratch/weixuz/decore && bash test_cad_cd.sh
```
