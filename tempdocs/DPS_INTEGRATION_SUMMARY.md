...
```
/scratch/weixuz/decore/src/models/
...
**Updated**:
```
/scratch/weixuz/decore/src/models/__init__.py
...
**Base decoder config**:
```yaml
/scratch/weixuz/decore/configs/decoder/dps.yaml
...
```
/scratch/weixuz/decore/configs/experiment/
...
```bash
/scratch/weixuz/decore/test_dps.sh
└── Runs 5 samples on LaMP-1 (~2 minutes)
```

**Run script** (full experiments):
```bash
/scratch/weixuz/decore/run_dps.sh
...
**Updated** `/scratch/weixuz/preference_head/run_detection.sh`:
- Fixed cache path: `/scratch/weixuz/decore/.cache/huggingface`
- Fixed output path: `/scratch/weixuz/preference_head/preference_scores/`
- Removed unnecessary HF token

**Created** `/scratch/weixuz/preference_head/PATH_CONFIGURATION.md`:
...
**Location**: `/scratch/weixuz/preference_head/preference_scores/Meta-Llama-3-8B-Instruct_LaMP_1_top_heads.json`
...
- [ ] Test DPS on LaMP-1 (5 samples): `bash test_dps.sh`
- [ ] Run full LaMP-1 experiment: `sbatch run_dps.sh`
...
| Purpose | File Path |
|---------|-----------|
| **Preference Heads** | `/scratch/weixuz/preference_head/preference_scores/Meta-Llama-3-8B-Instruct_LaMP_1_top_heads.json` |
| **DPS Decoder** | `/scratch/weixuz/decore/src/models/dps.py` |
| **DPS Config** | `/scratch/weixuz/decore/configs/decoder/dps.yaml` |
| **LaMP-1 Config** | `/scratch/weixuz/decore/configs/experiment/lamp_1/dps/llama3_8b_instruct.yaml` |
| **Test Script** | `/scratch/weixuz/decore/test_dps.sh` |
| **Run Script** | `/scratch/weixuz/decore/run_dps.sh` |
| **Full Docs** | `/scratch/weixuz/decore/DPS_INTEGRATION.md` |
| **Quick Start** | `/scratch/weixuz/decore/DPS_QUICK_START.md` |
...
- **Full Documentation**: `/scratch/weixuz/decore/DPS_INTEGRATION.md`
- **Quick Reference**: `/scratch/weixuz/decore/DPS_QUICK_START.md`
- **Path Guide**: `/scratch/weixuz/preference_head/PATH_CONFIGURATION.md`
- **Detection Guide**: `/scratch/weixuz/preference_head/README.md`
