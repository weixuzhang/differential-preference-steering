...
- Saved in: `/scratch/weixuz/preference_head/preference_scores/`
...
### Scripts (2 files)
- ✅ `test_dps.sh` - Quick test (5 samples)
- ✅ `run_dps.sh` - Full experiment (SLURM)
...
2. Run full experiment: `sbatch run_dps.sh`
...
**Next**: Run full experiment with `sbatch run_dps.sh` and analyze results! 🚀
