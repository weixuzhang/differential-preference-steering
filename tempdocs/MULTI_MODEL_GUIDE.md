...
ls /scratch/weixuz/preference_head/preference_scores/*_top_heads.json | wc -l

# Count prediction files
ls /scratch/weixuz/decore/outputs/pred_*.json | wc -l

# View evaluation summary
cat /scratch/weixuz/decore/outputs/evaluation_summary.json
```
...
```bash
cd /scratch/weixuz/preference_head && sbatch run_detection_multi_model.sh
```
