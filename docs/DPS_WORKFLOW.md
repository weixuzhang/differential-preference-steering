...
└── decore/                                # Experiments project
    ...
    │
    ├── experiments/test_dps.sh                        # Quick test ✅
    ├── experiments/run_dps.sh                         # Full run ✅
...
```
0:00  Start experiments/test_dps.sh
...
```
0:00   Start experiments/run_dps.sh (SLURM)
0:01   Load model (from cache)
...
**Next**: Run `bash experiments/test_dps.sh` to validate the complete workflow.
