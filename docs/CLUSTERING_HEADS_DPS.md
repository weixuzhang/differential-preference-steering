...
- Script: `scripts/run_weighted_dps.py`
- Inputs:
...
- Script: `experiments/hparam_scripts/run_llama3_lamp1_gamma_sweep.sh`
...
- Script: `experiments/hparam_scripts/run_llama3_lamp1_groupsize_sweep.sh`
