...
def _get_usable_length(past_key_value: Cache, seq_len: int, layer_idx: int) -> int:
    try:
        return past_key_value.get_usable_length(seq_len, layer_idx)
    except TypeError:
        try:
            return past_key_value.get_usable_length(seq_len)
        except TypeError:
            return past_key_value.get_usable_length()
...
class MistralModel(MistralPreTrainedModel):
    ...
    def forward(
        ...
        if use_cache:
            ...
            past_key_values_length = _get_usable_length(past_key_values, seq_length, 0)
        ...
        if past_key_values is not None:
            if isinstance(past_key_values, Cache):
                ...
                if hasattr(past_key_values, "get_max_length"):
                    ...
                    max_cache_length = _get_usable_length(
                        past_key_values, input_ids.shape[1], 0
                    )
                else:
