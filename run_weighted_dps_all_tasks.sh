#!/bin/bash
#SBATCH --job-name=dps_weighted_all
#SBATCH --output=dps_weighted_all_%j.out
#SBATCH --nodes=1
...
BASE_HEADS="/scratch/weixuz/preference_head/cluster_heads"
...
for task in "${TASKS[@]}"; do
  ...
  echo "========================================="
  python decore/scripts/run_weighted_dps.py \
    --task "${task}" \
